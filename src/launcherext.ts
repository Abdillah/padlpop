...
// import * as launcher from 'launchers';
...
//     search_results(expr: string): Array<launcher.SearchOption> | null {
...
//     search_results(query: string): Array<> | null {
